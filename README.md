...
## Дополнительные материалы по домашней работе

В репозиторий также добавлен Colab-ноутбук с оформлением домашней работы:

`notebooks/HW5_MLOps_Кучина_Екатерина.ipynb`

В нем собраны текстовые ответы по заданиям и оформлены ячейки для тех частей работы, где по условиям требовался артефакт именно в ноутбуке.

Отдельные ответы также сохранены в виде файлов в репозитории:

- сравнение традиционного ноутбука и Marimo:  
  `notebooks/notebook_vs_marimo.md`

- оценка готовности системы машинного обучения к развертыванию в рабочей среде:  
  `production_readiness.md`

Такое разделение я выбрала для того, чтобы основная реализация проекта оставалась в виде нормальной структуры репозитория, а текстовые пояснения и оформленные ответы были доступны в удобном и понятном виде.